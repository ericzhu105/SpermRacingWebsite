...
const COUNTRIES = [
  ...
  'Brazil', 'Mexico', 'Japan', 'South Korea', 'China', 'Italy', 'Spain', 'Netherlands',
  'Sweden', 'Norway', 'Denmark', 'Finland', 'Switzerland', 'Austria', 'Belgium',
  'Portugal', 'Ireland', 'New Zealand', 'South Africa', 'Nigeria', 'Kenya', 'Ghana',
  'Egypt', 'Morocco', 'Argentina', 'Colombia', 'Chile', 'Peru', 'Venezuela',
  'Philippines', 'Indonesia', 'Thailand', 'Vietnam', 'Malaysia', 'Singapore',
  'Pakistan', 'Bangladesh', 'Sri Lanka', 'Nepal', 'Turkey', 'Saudi Arabia',
  'United Arab Emirates', 'Israel', 'Poland', 'Czech Republic', 'Romania', 'Hungary',
  'Greece', 'Croatia', 'Serbia', 'Ukraine', 'Russia', 'Kazakhstan', 'Taiwan',
  'Hong Kong', 'Macau', 'Iceland', 'Luxembourg', 'Malta', 'Cyprus', 'Estonia',
  'Latvia', 'Lithuania', 'Slovakia', 'Slovenia', 'Bulgaria', 'Albania',
  'North Macedonia', 'Montenegro', 'Bosnia and Herzegovina', 'Kosovo',
  'Dominican Republic', 'Puerto Rico', 'Cuba', 'Jamaica', 'Trinidad and Tobago',
  'Haiti', 'Costa Rica', 'Panama', 'Guatemala', 'Honduras', 'El Salvador',
  'Nicaragua', 'Ecuador', 'Bolivia', 'Paraguay', 'Uruguay',
  'Ethiopia', 'Tanzania', 'Uganda', 'Rwanda', 'Cameroon', 'Senegal',
  'Ivory Coast', 'Democratic Republic of Congo', 'Angola', 'Mozambique',
  'Zimbabwe', 'Zambia', 'Botswana', 'Namibia', 'Madagascar',
  'Iraq', 'Iran', 'Afghanistan', 'Jordan', 'Lebanon', 'Kuwait', 'Qatar',
  'Bahrain', 'Oman', 'Yemen', 'Syria', 'Palestine',
  'Myanmar', 'Cambodia', 'Laos', 'Mongolia', 'Brunei', 'Fiji',
